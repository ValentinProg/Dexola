  ...
  return (
    <div className={styles.wrapperInput}>
      <div
        ...
        style={{ borderBottomColor: borderStyleForError(dirty, error) }}
      >
        {inputName === "phone" ? (
        ...
        <input
          onChange={(e) => {
            inputName === "confirmpassword"
              ? confirmValidation(e)
              : validationWithReg(e, reg, setValue, setError, errorText);
          }}
        ...
        {(inputName === "password" || inputName === "confirmpassword") && (
          <button onClick={() => setShown(!shown)}>
            <img
              className={styles.shownPassworEye}
              src={shown ? openEye : closeEye}
            />
          </button>
        )}
      </div>
